#load Data_applicazione.RData
#set WD
load("WD/Data_applicazione.RData")
...
iter = seq(10001,R,10)
c(mean(mu[1,1,iter]), mean(mu[1,2,iter]), mean(mu[1,3,iter]))
c(sqrt(mean(sigma[1,1,1,iter])), sqrt(mean(sigma[1,1,2,iter])), sqrt(mean(sigma[1,1,3,iter])))
mean(Beta_es[1,iter])
mean(Beta_es[2,iter])
mean(Betas_es[1,iter])
mean(Betas_es[2,iter])
mean(Gamma_es[1,2,iter])
mean(Gamma_es[1,3,iter])
mean(Gamma_es[2,1,iter])
mean(Gamma_es[2,3,iter])
mean(Gamma_es[3,1,iter])
mean(Gamma_es[3,2,iter])
mean(Gammas_es[1,2,iter])
mean(Gammas_es[1,3,iter])
mean(Gammas_es[2,1,iter])
mean(Gammas_es[2,3,iter])
mean(Gammas_es[3,1,iter])
mean(Gammas_es[3,2,iter])
mean(Delta_es[1,2,iter])
mean(Delta_es[1,3,iter])
mean(Delta_es[2,1,iter])
mean(Delta_es[2,3,iter])
mean(Delta_es[3,1,iter])
mean(Delta_es[3,2,iter])
