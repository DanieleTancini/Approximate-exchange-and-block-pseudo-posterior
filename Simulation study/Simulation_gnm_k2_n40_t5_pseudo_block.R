...
for(ss in 1:Simu){
  ...
  setwd("")
  load(paste0("Sim_Gnm_k2_n40_t5_sigmasqrt1_rv_r5_number_",ss,".Rdata"))  
  ...
  balanced_kmeans = function(Com, k){
    ...
    #Assignment with balance constraint 
    clusters = rep(NA, n)
  ...
  #setwd("")
  save.image(paste0("Sim_Gnm_k2_n40_t5_sigmasqrt1_rv_pseudo_block_adj_",ss,".Rdata"))
  rm(list = ls())
}
